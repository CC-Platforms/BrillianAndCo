...
<section class="ul-banner">
    ...
    {{-- Success Message --}}
    <div x-data="{ show: {{ session('success') ? 'true' : 'false' }} }" x-init="setTimeout(() => show = false, 4000)"
        x-show="show" x-transition class="container my-4">
                            ...
                            <div class="row align-items-center flex-sm-row flex-column-reverse">
                                ...
                                <div class="col-md-9 col-sm-8">
                                    ...
                                    <div class="ul-banner-slide-txt wow animate__fadeInUp">
                                        ...
                                        <p class="ul-banner-slide-descr">Discover our curated selection of premium
                                            properties. Let us help you find the perfect home or investment opportunity.
                                        </p>
                                        <div class="ul-banner-slide-btns">
                                            <a href="{{ route('buyer.index') }}" class="ul-btn-buy">Buy Now</a>
                                            <a href="{{ route('seller.index') }}" class="ul-btn-sell">Sell Now</a>
                            ...
                            <div class="row align-items-center flex-sm-row flex-column-reverse">
                                ...
                                <div class="col-md-9 col-sm-8">
                                    ...
                                    <div class="ul-banner-slide-txt wow animate__fadeInUp">
                                        ...
                                        <p class="ul-banner-slide-descr">Our team of experienced professionals is
                                            dedicated to providing exceptional service tailored to your real estate
                                            needs.</p>
                                        <div class="ul-banner-slide-btns">
                                            <a href="{{ route('buyer.index') }}" class="ul-btn-buy">Buy Now</a>
                                            <a href="{{ route('seller.index') }}" class="ul-btn-sell">Sell Now</a>
