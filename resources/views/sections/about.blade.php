                ...
                <div class="ul-about-txt ul-inner-about-txt">
                    ...
                    <div class="ul-about-txt-bottom ul-inner-about-txt-bottom">
                        <ul class="ul-inner-about-list">
                            <li><i class="flaticon-read-more-icon"></i> Trusted property consultancy in Cameroon</li>
                            <li><i class="flaticon-read-more-icon"></i> Wide portfolio of verified properties</li>
                            <li><i class="flaticon-read-more-icon"></i> Fast and reliable customer support</li>
                        </ul>
                    </div>
                </div>
            </div>
